...
data = {
    "contacts": [
        {
            "email": "spainpenguincubes@gmail.com",
            "name": "Clara"
        },
        {
            "email": "clararodriguezacevedo@gmail.com",
            "name": "Clarita"
        }
    ]
}
...
def convert_json_to_contact_list(data):
    to_emails = []
...
message = Mail(
    ...
    to_emails=convert_json_to_contact_list(data),
